          ...
          <div className="flex items-center space-x-2">
            ...
            <div>
              ...
              <div className="text-sm">
                {isRecording ? 'Screen recording detected' : 'Suspicious activity detected'}
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-4xl mx-auto">
        {!selectedSubject ? (
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 flex flex-col items-center justify-center">
            ...
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Please Select a Subject</h2>
            <p className="text-gray-600 mb-4">You need to select a subject before starting the exam.</p>
          </div>
        ) : (
          <>
            {/* Security Notice */}
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  <p className="text-sm text-yellow-700">
                    <strong>Security Notice:</strong> This exam is protected. Screen recording, copying, and suspicious activities are monitored and will be reported.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8 mb-8">
              <div className="bg-gray-100 -mx-8 -mt-8 px-8 py-4 mb-8 rounded-t-lg">
                <h3 className="text-lg font-medium text-gray-800">
                  {question.questionText} <span className="text"> ({currentQuestion}/{totalQuestions}) </span>
                </h3>
              </div>
