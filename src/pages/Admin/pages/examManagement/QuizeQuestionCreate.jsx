...
import { Calendar, Clock, BookOpen, Plus, Trash2, Edit3, Save, X, Check } from 'lucide-react';

const QuizeQuestionCreate = ({setShowCreateForm}) => {
    // Your original state and functions - unchanged
    const teacherId = "TEACHER_ID"; // Simplified for artifact
    ...
    // Your original mutation simulation
    const [isLoading, setIsLoading] = useState(false);
    const createQuizQuestion = async (quizData) => {
        setIsLoading(true);
        try {
            // Simulate API call
            ...
            // Reset everything - your original logic
            setQuestion({
                questionText: '',
                options: ['', '', '', ''],
                correctAnswer: '',
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-6">
                    <div className="flex items-center justify-center space-x-4">
                        <div className={`flex items-center space-x-2 px-4 py-2 rounded-full ${step === 1 ? 'bg-indigo-600 text-white' : 'bg-white text-indigo-600'}`}>
                            <BookOpen size={16} />
                            <span className="text-sm font-medium">Quiz Info</span>
                        </div>
                        <div className="w-8 h-px bg-gray-300"></div>
                        <div className={`flex items-center space-x-2 px-4 py-2 rounded-full ${step === 2 ? 'bg-indigo-600 text-white' : 'bg-white text-gray-400'}`}>
                            <Edit3 size={16} />
                    ...
                    {step === 1 ? (
                        ...
                        <form onSubmit={handleMetadataSubmit} className="p-8">
                            <div className="text-center mb-8">
                                ...
                                <p className="text-gray-600 mt-2">Set up your quiz details and requirements</p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.title && <p className="text-red-500 text-sm mt-1 flex items-center"><X size={14} className="mr-1" />{errors.title}</p>}
                                </div>
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.subject && <p className="text-red-500 text-sm mt-1 flex items-center"><X size={14} className="mr-1" />{errors.subject}</p>}
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.duration && <p className="text-red-500 text-sm mt-1 flex items-center"><X size={14} className="mr-1" />{errors.duration}</p>}
                                </div>
                                <div>
                                    <label className="block text-sm font-semibold text-gray-700 mb-2">
                                    ...
                                    <input
                                        ...
                                        required
                                    />
                                    {errors.scheduledAt && <p className="text-red-500 text-sm mt-1 flex items-center"><X size={14} className="mr-1" />{errors.scheduledAt}</p>}
                                </div>
                            </div>
                                ...
                                <div className="mb-6">
                                    ...
                                    <div className="space-y-3">
                                        {questions.map((q, index) => (
                                            <div key={index} className="bg-gradient-to-r from-green-50 to-emerald-50 p-6 rounded-xl border-2 border-green-200 hover:border-green-300 transition-colors">
                                                    ...
                                                    <div className="flex-1">
                                                        ...
                                                        <div className="grid grid-cols-2 gap-2 mb-3">
                                                            {q.options.map((option, optIndex) => (
                                                                <div key={optIndex} className={`text-sm px-3 py-2 rounded-lg ${option === q.correctAnswer ? 'bg-green-200 text-green-800 font-semibold' : 'bg-gray-100'}`}>
                                                                    {String.fromCharCode(65 + optIndex)}. {option}
                                                                    {option === q.correctAnswer && <Check size={14} className="inline ml-1" />}
                                                                </div>
                                                            ))}
                                                        </div>
                            ...
                            <div className="border-2 border-dashed border-indigo-300 p-6 rounded-xl bg-gradient-to-br from-indigo-50 to-blue-50">
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        />
                                        {errors.questionText && <p className="text-red-500 text-sm mt-1 flex items-center"><X size={14} className="mr-1" />{errors.questionText}</p>}
                                    </div>
                                    
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        {question.options.map((option, index) => (
                                            <div key={index}>
                                                <label className="block text-sm font-semibold text-gray-700 mb-1">Option {index + 1}</label>
                                                <input
                                                    type="text"
                                                    value={option}
                                                ...
                                                />
                                                {errors[`option${index}`] && <p className="text-red-500 text-xs mt-1 flex items-center"><X size={12} className="mr-1" />{errors[`option${index}`]}</p>}
                                            </div>
                                        ))}
                                    </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            {errors.correctAnswer && <p className="text-red-500 text-xs mt-1 flex items-center"><X size={12} className="mr-1" />{errors.correctAnswer}</p>}
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            />
                                            {errors.mark && <p className="text-red-500 text-xs mt-1 flex items-center"><X size={12} className="mr-1" />{errors.mark}</p>}
                                        </div>
                                    </div>
                                </div>
