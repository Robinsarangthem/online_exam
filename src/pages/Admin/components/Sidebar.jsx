...
export const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div
        className={`bg-gradient-to-b from-indigo-900 to-purple-900 text-white w-64 h-screen fixed left-0 top-0 p-6 shadow-2xl overflow-y-auto z-10 transition-transform duration-300 lg:translate-x-0 ${
            ...
            return item.id ? (
              <NavLink
                ...
                onClick={() => {
                  ...
                  localStorage.setItem("activeTab", item.id); // ✅ fixed here
