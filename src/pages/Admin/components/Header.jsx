            ...
            <div className="flex items-center space-x-2 sm:space-x-4 flex-shrink-0">
                ...
                <div className="flex items-center space-x-3 bg-gray-50 rounded-full px-3 py-2">
                    ...
                    <div className="hidden sm:block">
                        <p className="font-medium text-gray-800 text-sm whitespace-nowrap uppercase">{adminData?.username}</p>
                        <p className="text-xs text-gray-500 uppercase">{adminData?.role}</p>
                    </div>
                </div>
            </div>
        </div>
